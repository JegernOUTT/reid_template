...
from person_reid.modelling.common import ConvBlock, conv1x1_block, conv3x3_block

__all__ = ['ProxylessNASCPU', 'ProxylessNASGPU', 'ProxylessNASMobile', 'ProxylessNASMobile14']
...
class ProxylessNASCPU(ProxylessNAS):
...
class ProxylessNASGPU(ProxylessNAS):
    def __init__(self, **kwargs):
        super().__init__(
...
class ProxylessNASMobile(ProxylessNAS):
    def __init__(self, **kwargs):
        super().__init__(
...
class ProxylessNASMobile14(ProxylessNAS):
    def __init__(self, **kwargs):
        super().__init__(
