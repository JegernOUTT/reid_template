...
class OSNet(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = ConvLayer(
            input_channels, channels[0], 7, stride=2, padding=3, IN=conv1_IN
        )
...
class OSNET_AIN_x1_0(OSNet):
    def __init__(self,
        ...
        if pretrained:
            init_pretrained_weights(self, key='osnet_ain_x1_0')


class OSNET_AIN_x0_75(OSNet):
    def __init__(self,
                 input_channels=3,
                 pretrained=True,
                 **kwargs):
        ...
        if pretrained:
            init_pretrained_weights(self, key='osnet_ain_x0_75')


class OSNET_AIN_x0_5(OSNet):
    def __init__(self,
                 input_channels=3,
                 pretrained=True,
                 **kwargs):
        ...
        if pretrained:
            init_pretrained_weights(self, key='osnet_ain_x0_5')


class OSNET_AIN_x0_25(OSNet):
    def __init__(self,
                 input_channels=3,
                 pretrained=True,
                 **kwargs):
        ...
        if pretrained:
            init_pretrained_weights(self, key='osnet_ain_x0_25')
